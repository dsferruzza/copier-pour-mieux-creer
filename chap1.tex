...
Bien sûr, il y a un coût variable : les infrastructures qui supportent et constituent Internet, ainsi que les terminaux des utilisateurs ont besoin d'énergie pour fonctionner.
...
On pourrait dire qu'il y a copie lorsqu'on utilise dans une œuvre tout ou partie d'une autre œuvre, pour peu que les éléments importés n'aient pas été modifiés.
Mais on voit rapidement la limite de cette définition : y a-t-il toujours copie lorsqu'on parle d'éléments copiés d'autres œuvres mais si petits et élémentaires qu'on ne saurait identifier l'œuvre dont ils proviennent ?
