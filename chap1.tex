...
On peut la définir de la manière suivante : <<~droit d'user, de jouir et de disposer de quelque chose de façon exclusive et absolue sous les seules restrictions établies par la loi~>>\footnote{\textbf{NOM DU DICO}}.
...
L'idée, c'est qu'avant qu'autrui puisse dire qu'on s'est approprié son bien, qu'on l'a volé, il faut déjà que ce bien soit effectivement sa propriété, et d'abord qu'il puisse l'être.
...
Il n'hésiterait pas à faire la comparaison avec 1984 de Georges Orwell : <<~la guerre c'est la paix, l'ignorance c'est la force, l'esclavage c'est la liberté~>>.
