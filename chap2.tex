...
Pour de plus amples détails, je recommande le troisième chapitre du document <<~Sur la réforme du droit d'auteur~>>\footnote{\url{http://reformedroitauteur.sploing.fr/}} (si ce n'est l'ensemble), sur lequel je me baserai pour écrire cette partie.
...
Ensuite, des actions seront (ou non) réalisées sur les paquets en fonction de leur(s) étiquette(s).
Par exemple :
