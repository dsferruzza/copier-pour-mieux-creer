...
Dans le cas d'un exemplaire qui n'a pas été acheté directement à l'éditeur, le contenu est bloqué\footnote{On a déjà entendu parler de certains jeux qui allaient jusqu'à supprimer les sauvegardes du joueur lorsqu'il détectent que le jeu n'a pas été acheté}.
\end{itemize}
...
Reprenons l'exemple des jeux vidéos qui nécessitent une activation perpétuelle via Internet pour fonctionner.
